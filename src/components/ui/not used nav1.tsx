...
export function Nav1() {
  return (
    <NavigationMenu className="h-full min-w-full">
      <NavigationMenuList className="mx-0 flex w-full justify-between bg-slate-500">
        <NavigationMenuItem>
        ...
        <div className="relative inline-flex items-start gap-[10px] rounded-[12px] bg-[#ffca00] p-[24px]">
          <svg
