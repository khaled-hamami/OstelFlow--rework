    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <div className=" flex h-full w-full cursor-pointer items-center justify-evenly">
          <div className="relative flex w-[225.5px] items-start gap-[7px] rounded-2xl bg-background  p-[16px]">
      ...
      <DropdownMenuContent className="shadow">
        <Calendar mode="single" selected={date} onSelect={setDate} className="rounded-md shadow" />
      </DropdownMenuContent>
    </DropdownMenu>
  )
}
