            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-12 md:mt-0">
                ...
                <form className="mt-4 sm:flex sm:max-w-md">
                  ...
                  <input
                    autoComplete="email"
                    className="w-full min-w-0 appearance-none rounded-md border border-transparent bg-white px-4 py-2 text-base leading-6 text-gray-900 placeholder-gray-500 focus:border-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                  ...
                  <div className="mt-3 rounded-md shadow sm:ml-3 sm:mt-0 sm:flex-shrink-0">
                    <Button className="flex w-full items-center justify-center rounded-md border border-transparent bg-yellow-400 px-5 py-3 text-base font-medium text-gray-700 hover:bg-yellow-500">
